...
public class Player
{
    ...
    // POST: 
    {
        ...
        do
        {
            lots = getUpgradeableLots(this.getProperties());  // get a list of possible choice
            ...
            {
                this.changeMoney(-1 * lots[option-1].getUpgradeCost());  // take their money
        ...
        do
        {
            ...
            else if(option == 1)
            {
                do
                {
                    ...
                    if( option != 0)
                    {
                        ...
                        this.changeMoney(downgradeable[option-1].getUpgradeCost()/2);
                        sellable = getSellable();
                        downgradeable = getDowngradeable(sellable);
                    }
                }
            ...
            else if (option == 2)
            {
                do
                {
                    ...
                    if( option != 0)
                    {
                        this.changeMoney(sellable[option-1].getCost());
                        this.removeProperty(sellable[option-1]);
